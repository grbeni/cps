...
{"entries":[
{"activityName":"CPS lesson", "beginning":"Dec 8, 2018 1:15:00 PM",
...
When the server receives a request, it checks whether there is an activity registered in the file whose \textsl{beginning} and \textsl{end} attributes include the moment of the reception of the request. If so, it returns a message with attribute \textsl{activity} set to \emph{true}, otherwise to \emph{false}.
